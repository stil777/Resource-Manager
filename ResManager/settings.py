"""
Django settings for ResManager project.
...
SECRET_KEY = '4#-1^5sr6%gmr31i+4%+$xafmeapkj)41p&b0%!9d1fzwhyuzx'
...
WSGI_APPLICATION = 'ResManager.wsgi.application'
